...
plot2 = ggplot(df, aes(x = scenario, y = value)) +
  ...
  labs(
    colour = NULL,
    title = "(B) ADD Direct-To-Earth Cost by Scenario",
    subtitle = "Reported by NASA SCaN use case.",
    x = NULL,
...
plot3 = ggplot(df, aes(x = scenario, y = value)) +
  ...
  labs(
    colour = NULL,
    title = "(C) ADD Space Relay Cost by Scenario",
    subtitle = "Reported by NASA SCaN use case.",
    x = NULL,
    y = bquote("Service Cost (US$ Millions)"),
    fill = "",#"Use\nCase"
...
plot4 = ggplot(df, aes(x = scenario, y = value)) +
  ...
  labs(
    colour = NULL,
    title = "(D) ADD Launch Event Cost by Scenario",
    subtitle = "Reported by NASA SCaN use case.",
    x = NULL,
    y = bquote("Service Cost (US$ Millions)"),
    fill = "",#"Use\nCase"
...
plot5 = ggplot(df, aes(x = scenario, y = value)) +
  ...
  labs(
    colour = NULL,
    title = "(E) FDDN Direct-To-Earth Cost by Scenario",
    subtitle = "Reported by NASA SCaN use case.",
    x = NULL,
    y = bquote("Service Cost (US$ Millions)"),
    fill = "",#"Use\nCase"
...
plot6 = ggplot(df, aes(x = scenario, y = value)) +
  ...
  labs(
    colour = NULL,
    title = "(F) FDDN Space Relay Cost by Scenario",
    subtitle = "Reported by NASA SCaN use case.",
    x = NULL,
    y = bquote("Service Cost (US$ Millions)"),
    fill = "",#"Use\nCase"
...
folder <- dirname(rstudioapi::getSourceEditorContext()$path)
path = file.path(folder, 'figures', 'd_future_mission_cost.png')
